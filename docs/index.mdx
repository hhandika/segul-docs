...
It brings nearly similar speed and memory efficiency as the command line version, but with the convenience of GUI. Current version of SEGUI supports macOS, Windows, Android, and iOS. It's now available to test. To the test the app, checkout GUI installation section [here](https://docs.page/hhandika/segul-docs/gui_install). To see development progress, checkout the GitHub [repository](https://github.com/hhandika/segui).
