...
The fastest installation route for CLI is using the pre-compiled binaries [here](). Get the most up to date link for GUI installation [here](https://docs.page/hhandika/segul-docs/gui_install).
