...
- [Overview](#overview)
  ...
  - [Special arguments](#special-arguments)
    ...
    - [Percentage interval](#percentage-interval)
    - [Filtering options](#filtering-options)
    - [Extracting options](#extracting-options)
    - [Renaming options](#renaming-options)
    - [Translating options](#translating-options)
...
SUBCOMMANDS:
    ...
    rename       Batch renaming sequence IDs in multiple_values alignments
